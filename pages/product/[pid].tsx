        ...
        <Layout>
            ...
            <section className={`container`}>
                <div className={`flex flex-wrap justify-between mt-8`}>
                    ...
                    <div className={`min-w-0 lg:flex-1 lg:ml-5`}>
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="flex flex-col items-end flex-1 min-w-0">
                                <div>
                                    ...
                                    <i className="far fa-star"></i>
                                    <i className="far fa-star"></i>
                                    <span className="ml-5 text-sm text-black text-opacity-50"> 0.0 (0 đánh giá) </span>
                                </div>
                                <div className="mt-5">
                                    <span className="ml-5 text-sm text-black text-opacity-50">21 lượt mua</span>
                                    <span className="mx-2">|</span> <strong className="text-sm text-black">Hết
                                    hàng</strong>
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div>Hỗ trợ giảm đau nhức, mỏi cơ, cải thiện cơ khớp chắc
                                khỏe với mùi hương tự nhiên thơm mát mang lại cảm giác thư giãn dễ chịu
                            </div>
                        </div>
                        <div className="h-[1px] bg-[#845536] bg-opacity-20 my-4"></div>
                        <div className="detail__properties detail__properties__size">
                            ...
                            <div className="flex flex-wrap">
                                <Link href={``}
                                    ...
                                    <span className="mb-1 text-sm text-black text-opacity-70">300 ml</span>
                                    <span className="text-sm">1.658.000đ</span>
                                </Link>
                                <Link href={``}
                                      className="cursor-pointer inline-flex flex-col items-center relative border border-[#B78260] current-active:bg-[#FBECD5] bg-opacity-50 border-opacity-50 py-2 px-5 rounded-[3px] text-black text-decoration-none mr-4 mb-2">
                                    <span className="mb-1 text-sm text-black text-opacity-70">100 ml</span>
                        ...
                        <div className="py-2">
                            ...
                            <div className="flex justify-between mt-4 uppercase">
                                ...
                                <button type="button"
                                    ...
                                    <span className="text-lg font-extrabold text-[#845536]">Thêm vào giỏ hàng</span>
                                </button>
                            </div>
                        </div>
                    </div>
                ...
                <ul className="bg-white flex justify-center items-center border border-x-0 border-[#845536] border-opacity-20 py-4 mt-16">
                    <div className="block text-base border-transparent cursor-pointer border-y current-active current-active:border-b-black">Chi tiết sản phẩm</div>
                    <div className="block text-base border-transparent cursor-pointer ml-7 border-y current-active:border-b-black">Hướng dẫn</div>
                    <div className="block text-base border-transparent cursor-pointer ml-7 border-y current-active:border-b-black">Thành phần</div>
                    <div className="block text-base border-transparent cursor-pointer ml-7 border-y current-active:border-b-black">Hỏi đáp</div>
